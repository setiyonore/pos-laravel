<template>
    <Head>
        <title>Add New Roles - Aplikasi Kasir</title>
    </Head>
    <main class="c-main">
                            ...
                            <div class="card-body">
                                <form @submit.prevent="submit">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" v-model="form.name" :class="{ 'is-invalid': errors.name}" placeholder="Role Name">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline" v-for="(permission,index) in permissions" :key="index">
                                            <input type="checkbox" class="form-check-input" v-model="form.permissions" :value="permission.name" :id="`check-${permission.id}`">
