                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="password" v-model="form.password_confirmation" placeholder="Password Confirmation">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- row -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-check-inline" v-for="(role,index) in roles" :key="index">
                                                    <input type="checkbox" class="form-check-input" v-model="form.roles" :value="role.name" :id="`check-${role.id}`">
